...
void v_LL_decomp_fp32(  
  ...
  L32_real = vfnmsac_vv_f32m1(L32_real, L30_real, L20_real, vl);
  vfloat32m1_t L32_imag = vle32_v_f32m1(&Gram_imag[GET_IDX(3, 2, 0, nr, vl)],vl);
  L32_real = vfmacc_vv_f32m1(L32_real, L30_imag, L20_imag, vl);

  L32_imag = vfnmsac_vv_f32m1(L32_imag, L30_real, L20_imag, vl);
  L32_imag = vfnmsac_vv_f32m1(L32_imag, L30_imag, L20_real, vl);

  L32_real = vfnmsac_vv_f32m1(L32_real, L31_real, L21_real, vl);
  L32_real = vfmacc_vv_f32m1(L32_real, L31_imag, L21_imag, vl);

vfloat32m1_t L33_real = vle32_v_f32m1(&Gram_real[GET_IDX(3, 3, 0, nr, vl)],vl); 
  L32_imag = vfnmsac_vv_f32m1(L32_imag, L31_real, L21_imag, vl);
  L32_imag = vfnmsac_vv_f32m1(L32_imag, L31_imag, L21_real, vl);
