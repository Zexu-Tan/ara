...
def main():
    ...
    p.add_argument("--N_BEAM", type=int, default=32, help="Third dimension (default 64)")
    p.add_argument("--SNR",type=int, default = 25, help = "Signal to Noise Ratio (default 25dB)")
