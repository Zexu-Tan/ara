...
static inline void vcfmul_vv_f32m1_sim(
    ...
    size_t vl)
{
    ...
    *cr = vfnmsac_vv_f32m1(vfmul_vv_f32m1(ar, br, vl), ai, bi, vl);   // r -= ai*bi

    *ci = vfmacc_vv_f32m1(vfmul_vv_f32m1(ar, bi, vl), ai, br, vl);    // i += ai*br
}


static inline void vcfmac_vv_f32m1_sim(  
    //c = a * b + p0  
    vfloat32m1_t a_real,
    vfloat32m1_t a_imag,
    vfloat32m1_t b_real,
