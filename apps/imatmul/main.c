...
extern int64_t a[M * N] __attribute__((aligned(32 * NR_LANES), section(".l2")));
extern int64_t b[N * P] __attribute__((aligned(32 * NR_LANES), section(".l2")));
extern int64_t c[M * P] __attribute__((aligned(32 * NR_LANES), section(".l2")));
